  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        {/* Converter Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 l:grid-cols-4 gap-6 mb-20 justify-center">
          {converterOptions.map((option, index) => (
            ...
            >
              <div className={`${option.color} w-12 h-12 rounded-lg flex items-center justify-center mb-6 text-gray-700`}>
                {option.icon}
              </div>
